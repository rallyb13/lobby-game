  ...
  getPhaseData: function(phase){
    var phaseMap = {
      ...
      4: { playMsg: "",
        ...
        winMsg: "You won the nomination! Other party's actually putting up a challenge, but nothing you can't handle.",
        moves: 145, goal: 50000 },
      5: { playMsg: "",
        failMsg: "a consultant, whatever that is. You'll 'work' remote and net $120K/yr.",
        winMsg: "You're in for another term as State Delegate ... incumbency looks good on you! You can stick around for as long as you like now.",
        moves: 45, goal: 20000 },
      6: { playMsg: "",
      ...
      7: { playMsg: "",
        ...
        winMsg: "Congrats, State Senator. Give agribusiness a leg up, and they'll send a fatty paycheck to help you out.",
        moves: 180, goal: 50000 },
      8: { playMsg: "",
        ...
        winMsg: "You made it through the primary, but WHOA, here comes a tough general election! You're gonna have to put the 'aggro' in Big Agro.",
