...
var Utils = {
  ...
  getPhaseData: function(phase){
    var phaseMap = {
      ...
      8: { playMsg: "Oh criminy. Remember Peter Pandurin? Of course you do. He may have voted with us in the House, but what a jerk. Rumor has it he's gonna challenge you for your seat now that you've won it for the party.",
  ...
  progressGame: function(phase, moves) {
    var data,
      progressionMap = {
          ...
          2: {
            135: {
              tokens: {'oil1': 5, 'oil2': 3, 'oil3': 1, 'con1': 1},
              nextTrigger: 98
            },
            98: {
            ...
            63: {
              tokens: {'oil1': 8, 'oil2': 5, 'oil3': 2, 'con1': 3, 'mega': 1},
              nextTrigger: 17
            },
            17: {
              tokens: {'oil1': 2, 'oil2': 3, 'oil3': 2, 'con1': 2, 'mega': 1},
              nextTrigger: 33
            }
          },
          3: {
            33: {
              tokens: {'oil1': 5, 'oil2': 3, 'oil3': 1, 'con1': 2, 'mega': 1},
              nextTrigger: 130,
              special: "hold"
            }
          },
          4: {
            130: {
              tokens: {'oil1': 8, 'oil2': 5, 'oil3': 1, 'con1': 3},
              nextTrigger: 56
            },
            56: {
